    ...
    <div className="space-y-5 animate-fade-in">
      ...
      >
        ...
        <div className="relative">
          ...
          {/* Search Bar */}
          <div
            className="flex items-center rounded-2xl border-2 bg-white transition-all overflow-hidden mb-3 hover:border-teal-400/50 focus-within:border-teal-500 focus-within:ring-2 focus-within:ring-teal-100"
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
        {CATEGORIES.map((cat) => (
          <button
            ...
            className={`whitespace-nowrap flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold transition-all duration-200 ${selectedCategory !== cat.label && 'hover:bg-slate-50 hover:border-slate-300'}`}
            style={{
              ...
              boxShadow: selectedCategory === cat.label ? '0 4px 12px -2px rgba(13,148,136,0.4)' : '0 1px 3px rgba(0,0,0,0.04)',
              transform: selectedCategory === cat.label ? 'scale(1.05)' : 'scale(1)',
            }}
          >
            <span>{cat.emoji}</span>
            {cat.label}
